...
class SensorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamSensorData = channel.stream_stream(
                ...
                response_deserializer=sensor__pb2.DashboardUpdate.FromString,
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamSensorData': grpc.stream_stream_rpc_method_handler(
                    ...
                    response_serializer=sensor__pb2.DashboardUpdate.SerializeToString,
            ),
    }
...
class SensorService(object):
    ...
    def StreamSensorData(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            sensor__pb2.DashboardUpdate.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
